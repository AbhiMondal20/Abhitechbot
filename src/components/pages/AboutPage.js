  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn more about me and my passion for web development. Discover my skills, experiences, and the journey that led me to the world of coding and design."
        />
        <meta
          name="keywords"
        ...
        <title>Abhitechbot | Transforming Ideas into Digital Realities A Web Developer's Odyssey</title>
      </Helmet>
